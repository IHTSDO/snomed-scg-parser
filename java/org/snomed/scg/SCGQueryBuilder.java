...
import org.snomed.scg.domain.model.Attribute;
import org.snomed.scg.domain.model.AttributeGroup;
import org.snomed.scg.domain.model.AttributeValue;
import org.snomed.scg.domain.model.DefinitionStatus;
import org.snomed.scg.domain.model.Expression;
import org.snomed.scg.generated.ImpotentSCGListener;
import org.snomed.scg.generated.parser.SCGLexer;
import org.snomed.scg.generated.parser.SCGParser;
...
public class SCGQueryBuilder {
	...
	public Expression createQuery(String scg) {
		...
		try {
			...
			throw new SCGException("Failed to parse SCG '" + scg + "'", e);
		}
